...
import com.tostado.cashier.entities.Customer;
...
public class CustomerController extends Controller implements Initializable {
    ...
    @FXML private TableColumn<Customer, String> column3;
    @FXML private TableColumn<Customer, String> column4;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                textfield1.setText(selectedObject.getPhoneNumber());
                textfield2.setText(selectedObject.getFirstName());
                textfield3.setText(selectedObject.getLastName());
                textfield4.setText(selectedObject.getAddress());
            }
        });

        column1.setCellValueFactory(new PropertyValueFactory<Customer, String>("phoneNumber"));
        column2.setCellValueFactory(new PropertyValueFactory<Customer, String>("firstName"));
        column3.setCellValueFactory(new PropertyValueFactory<Customer, String>("lastName"));
        column4.setCellValueFactory(new PropertyValueFactory<Customer, String>("address"));
    }
        ...
        if(!textfield1.getText().isEmpty()) {
            if(!textfield2.getText().isEmpty()) {
                if(!textfield3.getText().isEmpty()) {
                    String temp1 = textfield1.getText().replaceAll("[\\s\\-()]", "");
                    String temp2 = textfield2.getText();
                    String temp3 = textfield3.getText();
                    String temp4 = textfield4.getText();

                    Customer temp = new Customer(-1, temp1, temp2, temp3, temp4);
                    ...
                    failureAlert.setContentText("Please enter the last name.");
                    failureAlert.showAndWait();
                }
            }else{
                failureAlert.setContentText("Please enter the first name.");
                failureAlert.showAndWait();
            }
        }else{
            failureAlert.setContentText("Please enter a phone number.");
            failureAlert.showAndWait();
        }
    }
                ...
                if (!textfield2.getText().isEmpty()) {
                    if (!textfield4.getText().isEmpty()) {
                        ...
                        if (result.get() == ButtonType.OK) {
                            ...
                            String temp3 = textfield3.getText();
                            String temp4 = textfield4.getText();
                            if (selectedObject.edit(temp1, temp2, temp3, temp4)) {
                                clearTextBox();
                                loadData();
        ...
        try {
            ...
            if (resultSet != null) {
                ...
                while (resultSet.next()) {
                    Customer temp = new Customer(resultSet.getInt("ID"), resultSet.getString("phoneNumber"), resultSet.getString("firstName"), resultSet.getString("lastName"), resultSet.getString("address"));
